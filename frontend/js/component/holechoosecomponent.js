class HoleChooseComponent extends Fronty.ModelComponent {

    constructor(holesModel, userModel, router) {
        
      super(Handlebars.templates.holechoose, holesModel);
      ...
      this.addEventListener('click', '#choosebutton', () => {
        ...
        this.router.goToPage('edit-hole?id=' + hole.pollId + '&date=' + hole.date + '&timeStart=' + hole.timeStart);
      });
    }
